<template>
    <div class="container float-start my-4">
        ...
        <button class="w-50 btn btn-primary rounded-0 btn-outline-info "><a href="/todo_list" class="text-decoration-none text-white w-50">Todo_list</a></button><br>
        <button class="bawah w-50  btn btn-primary btn-outline-info "><a href="/clock" class="text-decoration-none text-white w-50">clock</a></button><br>
    </div>
</template>
